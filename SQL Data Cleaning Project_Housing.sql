 ...
 */
 ...
 ALTER TABLE NashvilleHousing     /*Add a new column at the end of the table named SaleDateConverted*/
...
/*This query is to check if table a will be populated correctly using the information from table b*/
...
-- Breaking out Address into Individual Columns (Address, City, State)
 ...
 --Execute first the Alter and the the Update
...
FROM PortfolioProjects.dbo.NashvilleHousing
--ORDER BY ParcelID
-- where row_num >1 /*won't work without the CTE*/
)
SELECT *
FROM RowNumCTE
WHERE row_num > 1 /*There are 104 duplicates*/
...
CREATE VIEW CleanNashvilleHousing AS
SELECT *
FROM PortfolioProjects.dbo.NashvilleHousing
